...
**C)** Du skal betale et ekstra gebyr for store genstande.  
**D)** Du skal selv sørge for at pakke dine ting ned.
...
**C)** Man skal rydde op efter sig selv i kantinen.  
**D)** Kantinens åbningstider er blevet ændret.
...
**C)** Man skal have skriftlig tilladelse for at holde arrangementer i parken.  
**D)** Alle er velkomne til at grille i parken, så længe man rydder op.
...
**C)** Alle gader i midtbyen vil være totalt spærret for kørsel.  
**D)** Man skal have en særlig tilladelse for at sælge pølser.
...
**C)** Kommunen har indført en ny type skraldespand.  
**D)** Du skal selv køre dit restaffald til genbrugspladsen.
...
**C)** Du skal have et fisketegn for at opholde dig ved åen.  
**D)** Du må kun grille ved de officielle grillpladser nede ved åen.
...
**C)** Du mister dit lånerkort, hvis du afleverer for sent.  
**D)** Alle bøger skal nu afleveres digitalt.
...
**C)** Man skal undgå at skrive noget, der er længere end tre sætninger.  
**D)** Man må gerne bruge Comic Sans, hvis budskabet er vigtigt.
...
**C)** Man må gerne sætte hele kommunen i cc.  
**D)** Del kun information mundtligt ved kaffeautomaten.
...
**Tekst:** Det faciliteres hermed, at der foretages en vertikal transport af fermenterede fluider med henblik på at optimere den sociale kohæsion i forsamlingen.

**A)** Elevatoren skal repareres, så vi kan komme op til festen.  
**B)** Vi skal skåle og drikke øl/vin for at hygge os.  
**C)** Vi skal flytte møblerne for at få plads til at danse.  
**D)** Der er problemer med kloakken på anden sal.
...
**C)** Det er ikke min skyld, at det gik i stykker.  
**D)** Jeg lover at betale for det, jeg har ødelagt.
...
**C)** Vores hjemmeside er nede og skal opdateres.  
**D)** Vi skal ansætte flere folk i kommunikationsafdelingen.
...
**Tekst:** Vi har iværksat en dybdegående analyse af mulighederne for en fremtidig optimering af ressourceallokeringen, men p.t. er handlingsrummet begrænset.

**A)** Vi gør ingenting lige nu / vi har ikke råd.  
**B)** Vi har masser af penge, vi skal bare finde ud af, hvad vi skal købe.  
**C)** Vi ansætter en ny chef i morgen.  
**D)** Vi har løst alle problemerne.
...
**Tekst:** Subjektet har ikke afgivet eksplicit samtykke til databehandling af personfølsomme oplysninger i visuelt format på sociale platforme.

**A)** Du må ikke tage billeder af mig og lægge dem på nettet!  
**B)** Jeg har glemt min adgangskode til Facebook.  
**C)** Jeg vil gerne være venner på LinkedIn.  
**D)** Kan du sende mig dokumenterne på en krypteret mail?
...
**C)** Vi har vedtaget lovforslaget.  
**D)** Alle er gået hjem i vrede.
...
**Tekst:** Kontraktgrundlaget indeholder en klausul, der muliggør terminering af samarbejdet med øjeblikkelig virkning ved grov misligholdelse.

**A)** Du får lønforhøjelse.  
**B)** Vi skal have ny kaffeordning.  
**C)** Du er fyret på stedet.  
**D)** Du skal arbejde over i weekenden.
